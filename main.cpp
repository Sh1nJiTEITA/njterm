...
//                         win::Window &window, ren::AttachmentColorH
//                         &color_att, ren::RenderContextH &render_context,
...
//     render_context->ClearFramebuffers();
//     render_context->ClearCmds();
//     // render_context->ClearSyncDatas();
//     color_att.reset();
//     swapchain.reset();
...
//
//     color_att = log::MakeSharedWithLog<ren::AttachmentColor>("Color
//     attachment",
//                                                              swapchain);
//
//     // render_context->CreateSyncDatas(device);
//     render_context->CreateCmds(device, command_pool);
//     render_context->CreateFramebuffers(
...
int main(int argc, char **argv) {
    ...
    // auto surface = log::MakeSharedWithLog<ren::Surface>(inst,
    // win->CreateSurface(inst->Handle()));
    // // //
    ...
    // // //
    // auto allocator = log::MakeSharedWithLog<ren::Allocator>(inst, device,
    // physical_device);
    // // //
    // //
    ...
    // // //
    // auto color_att = log::MakeSharedWithLog<ren::AttachmentColor>("Color
    // attachment", swapchain); auto render_pass =
    // log::MakeSharedWithLog<ren::GridRenderPass>(device, color_att); auto
    // command_pool = log::MakeSharedWithLog<ren::CommandPool>(device,
    // physical_device);
    // // //
    ...
    // );
    // // // auto desc_test =
    // log::MakeSharedWithLog<ren::DescriptorTest>("DescriptorTest");
    ...
    // //
    // auto clear_color = vk::ClearValue { vk::ClearColorValue{0.2f, 0.2f, 0.2f,
    // 0.2f} } ;
    // //
    ...
    //             desc_context->BindSets(0, frame, command_buffer,
